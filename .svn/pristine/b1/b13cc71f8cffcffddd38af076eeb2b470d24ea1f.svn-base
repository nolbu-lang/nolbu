...
%>
<script>
_reportWrite000TabId = "<%=tabId%>";
</script>
<script src="${pageContext.request.contextPath}/js/report/reportWrite000.js"></script>
...
<div class="contents" style="height:100%;">
  ...
  <div id="mainBody" class="nondiv" style="height:95%;margin: 0 auto;width: 100%;min-width: 700px;_width: 700px;overflow: auto;">
    <div id="mainNorth" class="pane ui-layout-north" style="border:0px;overflow-x: hidden;">
        ...
        <table>
          ...
          <tbody>
          	<!-- <tr>
            	<th>분류</th>
            	<td>
            		<select id="condReportMstrGrp" name="condReportMstr" title="대분류" style="width:90%;">
                	</select>
            	</td>
            	<td colspan="2">
            		<select id="condReportCdGrp" name="condReportCd" title="중분류" style="width:90%;">
                	</select>
            	</td>
            	<td>
		            <select id="condReportDetlCdGrp" name="condReportDetlCd" title="소분류" style="width:93%;">
                	</select>
            	</td>
            </tr> -->
            <tr>
      ...
      <div class="btn">
        <div class="btnR">
          <a id="saveSheetBtn" class="btnClass" href="#" >집계표저장</a>
          <a id="saveSheetBtnNew" class="btnClass" href="#" >집계표저장_new</a>
          <a id="saveSheet001Btn" class="btnClass" href="#" >기준인건비저장</a>
          <a id="saveSheet002Btn" class="btnClass" href="#" >기초자료저장</a>
