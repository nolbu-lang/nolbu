$(document).ready(function() {
    ...
    var getSearchParam = function(){
        ...
        var bgtDgrNm = $("#condBgtDgr option:selected", tabObj).text();
    ...
    $("#saveSheet002Btn", tabObj).click(function() {
        ...
        */
        ...
        var contReportCd = $("#condReportCd option:selected", tabObj).val();
        var condReportDetlCd = $("#condReportDetlCd option:selected", tabObj).val();
        ...
        param["condReportCd"] = contReportCd;
        param["condReportDetlCd"] = condReportDetlCd;
        param["amtUnit"] = "1000";
