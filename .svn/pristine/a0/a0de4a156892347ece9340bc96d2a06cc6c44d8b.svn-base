$(document).ready(function() {
    var tabId = _reportWrite0A0TabId;
    var tabObj = $("#"+tabId);
    ...
    reportWirte0A0DialogDgrcompoModifyCallBackFunction = function(param){
        var rowId = param.dgrcompoId;
        if(isEmpty(rowId) == true){
            return;
        }
        
        reportWrite0A0Grid.jqGrid('setRowData', rowId, param);
    ...
    reportWirte0A0OpenDialogDgrcompoModify = function(rowId){  
        var rowData = reportWrite0A0Grid.getRowData(rowId);
        
        $("#dialogDgrcompoModifyCallBackFunction", $("#dialogDgrcompoModifyDiv")).val("reportWirte0A0DialogDgrcompoModifyCallBackFunction");
    ...
    var editFormatter = function(cellValue, options, rowObject){
        ...
        var rVal = '<a href="javascript:reportWirte0A0OpenDialogDgrcompoModify(\''+options.rowId+'\');"><span class="ui-icon ui-icon-pencil"></span></a>';
    ...
    var mainBodyResize = function(){
        if(isEmpty($("#REPORT_WRITE0A0_GRD", $("#"+tabId))) == false){
            $("#REPORT_WRITE0A0_GRD", $("#"+tabId)).setGridHeight(getGridHeight());
            $("#REPORT_WRITE0A0_GRD", $("#"+tabId)).setGridWidth($("#mainCenter", tabObj).width());
        }
    };
    ...
    var reportWrite0A0Grid = $("#REPORT_WRITE0A0_GRD", tabObj);
    ...
    var doSearchCallBack = function(data){
        ...
        $("#REPORT_WRITE0A0_GRD", tabObj).jqGrid('GridUnload');
        reportWrite0A0Grid = $("#REPORT_WRITE0A0_GRD", tabObj);
        reportWrite0A0Grid.csTreeGrid({
            datastr : data,
        ...
        reportWrite0A0Grid.jqGrid('setGroupHeaders', {
            useColSpanStyle : true,
            groupHeaders : groupHeaders
        });
        
        $("#REPORT_WRITE0A0_GRD", tabObj).closest(".ui-jqgrid-bdiv").scrollTop(gridScrollPosition);
    ...
    var doSearch = function(){
        ...
        gridScrollPosition = $("#REPORT_WRITE0A0_GRD", tabObj).closest(".ui-jqgrid-bdiv").scrollTop();
        
        $.csAjaxCall({
            url : "/report/ajaxReportWrite0A0Report0A0List.do",
            data: getSearchParam(),
            async : true,
    ...
    var doSave = function(params){
        ...
        var saveDatas = getSaveDatas(reportWrite0A0Grid, $("#REPORT_WRITE0A0_GRD", tabObj)[0].rows);
        ...
        $.csAjaxCall({
            url : "/report/ajaxReportWrite0A0SaveReport0A0.do",
    ...
    $("#saveFileBtn", tabObj).click(function() {
        ...
        param["fileNm"] = "경상사업시장님보고서식";
        param["amtUnit"] = "1000000";
        
        $.bcjisExcelAjaxCall({
            url : "/report/ajaxReportWrite0A0SaveFile.do"
          , data: param
        });
    });
    ...
    $("#saveSheetBtn", tabObj).click(function() {
        ...
        $.bcjisExcelAjaxCall({
            url : "/report/ajaxReportWrite0A0SaveSheet.do"
          , data: param
        });
    });
    ...
    $("#saveSheetBtn2", tabObj).click(function() {
        var param = getSearchParam();
        param["fileNm"] = "경상사업시장님보고서식_시장님보고";
        param["amtUnit"] = "1000000";
    ...
    var openDialogBgtDeptSelt = function(seltFg){
        ...
        $("#dialogDgrDeptSeltCallBackFunction", $("#dialogDgrDeptSeltDiv")).val("reportWrite0A0DialogDgrDeptSeltCallBack");
        ...
        $("#dialogDgrDeptSeltReportCd", $("#dialogDgrDeptSeltDiv")).val("0A0");
        $("#dialogDgrDeptSeltUserDeptYn", $("#dialogDgrDeptSeltDiv")).val("");
        
        $("#dialogDgrDeptSeltDiv").dialog('open');
    };
    
    reportWrite0A0DialogDgrDeptSeltCallBack = function(param){
    ...
    var comboParam = [
                      ...
                      {id : "officeCd", subQueryId : "OfficeCd", reportCd: "0A0"},
