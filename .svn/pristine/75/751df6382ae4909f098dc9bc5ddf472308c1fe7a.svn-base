...
@Controller
public class ReportWrite030Controller {
    /**
    ...
    Report030SaveFile report030SaveFile;

    @Resource(name = "bcjisCommService")
    private BcjisCommService bcjisCommService;

    @RequestMapping("/report/reportWrite030.do")
    public String reportWrite030(Map<String, String> commandMap, ModelMap model, HttpServletRequest request) throws Exception {
        if (logger.isDebugEnabled()) {
            logger.debug("reportWrite030(Map, ModelMap, HttpServletRequest) - start");
        }

        if (logger.isDebugEnabled()) {
            logger.debug("reportWrite030(Map, ModelMap, HttpServletRequest) - end");
        }
        return "report/reportWrite030";
    }

    @RequestMapping("/report/ajaxReportWrite030Report030List.do")
    public ModelAndView ajaxReportWrite030ReportWrite030List(ModelMap model, HttpServletRequest request) throws Exception {
        if (logger.isDebugEnabled()) {
            logger.debug("ajaxReportWrite030ReportWrite030List(ModelMap, HttpServletRequest) - start");
        }
        ...
        try {
            ...
            JSONArray resultList = JSONArray.fromObject(reportWrite030Service.selectReport030List(jsonParam));
            ...
            logger.error("ajaxReportWrite030ReportWrite030List(ModelMap, HttpServletRequest)", e);
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("ajaxReportWrite030ReportWrite030List(ModelMap, HttpServletRequest) - end");
        }
        return ajaxModel;
    }

    @RequestMapping("/report/ajaxReportWrite030SaveReport030.do")
    public ModelAndView ajaxReportWrite030SaveReport030(ModelMap model, HttpServletRequest request) throws Exception {
        if (logger.isDebugEnabled()) {
            logger.debug("ajaxReportWrite030SaveReport030(ModelMap, HttpServletRequest) - start");
        }
        ...
        try {
            ...
            jsonParam.put("userId", bcjisUserVO.getUserId());
            reportWrite030Service.saveReport030(jsonParam);

            jsonObject.put(BcjisCommUtil.BCJIS_RETURN_CODE, BcjisCommUtil.BCJIS_RETURN_CODE_SUCC);
            jsonObject.put(BcjisCommUtil.BCJIS_MESSAGE, bcjisMessageSource.getMessage("success.common.save"));
        } catch (Exception e) {
            logger.error("ajaxReportWrite030SaveReport030(ModelMap, HttpServletRequest)", e);
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("ajaxReportWrite030SaveReport030(ModelMap, HttpServletRequest) - end");
        }
        return ajaxModel;
    }
    
    @RequestMapping("/report/ajaxReportWrite030SaveFile.do")
    public ModelAndView ajaxReportWrite030SaveFile(ModelMap model, HttpServletRequest request) throws Exception {
        if (logger.isDebugEnabled()) {
            logger.debug("ajaxReportWrite030SaveFile(ModelMap, HttpServletRequest) - start");
        }
        ...
        try {
            ...
            if ("".equals(jsonParam.get("reportDetlCd")) == true) {
            	...
            	JSONArray totList = JSONArray.fromObject(reportWrite030Service.selectReport030Sheet001List(jsonParam));
            	JSONArray dataList = JSONArray.fromObject(reportWrite030Service.selectReport030ExcelList(jsonParam));
                ...
                if ("034".equals(jsonParam.get("reportDetlCd")) == true) {
                    jsonParam.put("dataList034", JSONArray.fromObject(reportWrite030Service.selectReport034ExcelList(jsonParam)));
                }else{
                    jsonParam.put("dataList", JSONArray.fromObject(reportWrite030Service.selectReport030ExcelList(jsonParam)));
                }
                JSONArray totList = JSONArray.fromObject(reportWrite030Service.selectReport030Sheet001List(jsonParam));

                jsonParam.put("totList", totList);
 
                report030SaveFile.buildExcelDocument(jsonParam, "RP", "");
            }
            ...
            logger.error("ajaxReportWrite030SaveFile(ModelMap, HttpServletRequest)", e);
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("ajaxReportWrite030SaveFile(ModelMap, HttpServletRequest) - end");
        }
        return ajaxModel;
    }

    @RequestMapping("/report/ajaxReportWrite030SaveSheet.do")
    public ModelAndView ajaxReportWrite030SaveSheet(ModelMap model, HttpServletRequest request) throws Exception {
        if (logger.isDebugEnabled()) {
            logger.debug("ajaxReportWrite030SaveSheet(ModelMap, HttpServletRequest) - start");
        }
        ...
        try {
            ...
            report030SaveFile.buildSheetDocument(jsonParam, "RP", "");

            jsonObject.put("fileName", jsonParam.get("fileName"));
            jsonObject.put("realFileName", jsonParam.get("realFileName"));
            jsonObject.put(BcjisCommUtil.BCJIS_RETURN_CODE, BcjisCommUtil.BCJIS_RETURN_CODE_SUCC);
        } catch (Exception e) {
            logger.error("ajaxReportWrite030SaveSheet(ModelMap, HttpServletRequest)", e);
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("ajaxReportWrite030SaveSheet(ModelMap, HttpServletRequest) - end");
        }
        return ajaxModel;
    }
}
