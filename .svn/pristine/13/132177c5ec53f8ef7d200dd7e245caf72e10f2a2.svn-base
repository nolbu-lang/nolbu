...
public class Report0D0SaveFrscAmtsVO {
    ...
    public Report0D0SaveFrscAmtsVO(String frscNm, long dmnFrscAmt, long preFrscAmt, long preDefFrscAmt, long frscAmt) {
        this.frscNm = frscNm;
    ...
    public String toString() {
        return "Report0D0SaveFrscAmtsVO [frscNm=" + frscNm + ", dmnFrscAmt=" + dmnFrscAmt + ", preFrscAmt=" + preFrscAmt + ", preDefFrscAmt=" + preDefFrscAmt + ", frscAmt=" + frscAmt + "]";
    }
