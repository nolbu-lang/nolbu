...
%>
<script>
_reportWrite0D0TabId = "<%=tabId%>";
</script>
<script src="${pageContext.request.contextPath}/js/report/reportWrite0D0.js"></script>
...
<div class="contents" style="height:100%;">
  ...
  <div id="mainBody" class="nondiv" style="height:95%;margin: 0 auto;width: 100%;min-width: 700px;_width: 700px;overflow: auto;">
    <div id="mainNorth" class="pane ui-layout-north" style="border:0px;overflow-x: hidden;">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <th>조서상세구분</th>
              <td colspan="2">
                <input type="hidden" id="condReportCd" name="condReportCd" value="0D0"/>
      ...
      <div class="btn">
        <div class="btnR">
          ...
          <a id="saveSheetBtn2" class="btnClass" href="#">현안사업보고조서저장</a>
          <a id="saveSheetBtn3" class="btnClass" href="#">현안조서저장(국명칭제외)</a>
    ...
    <div id="mainCenter" class="pane ui-layout-center" style="border:0px;">
      ...
      <div id="REPORT_WRITE0D0_DIV" class="csGrid" style="border:0px;">
        <table id="REPORT_WRITE0D0_GRD" style="border:0px;height:100%;"></table>
      </div>
    </div>
  </div>
  <!--list e-->
