$(document).ready(function() {
    ...
    reportWirte020DialogDgrcompoModifyCallBackFunction = function(param){
        ...
        reportWrite020PageGrid.jqGrid('setRowData', rowId, param);
       
        $("#preFrscAmt0_"+rowId).html(addCommaStr(param.preFrscAmt0));
        $("#preFrscAmt1_"+rowId).html(addCommaStr(param.preFrscAmt1));
        $("#preFrscAmt2_"+rowId).html(addCommaStr(param.preFrscAmt2));
        $("#preFrscAmt3_"+rowId).html(addCommaStr(param.preFrscAmt3));
        $("#preFrscAmt4_"+rowId).html(addCommaStr(param.preFrscAmt4));
        $("#preFrscAmt5_"+rowId).html(addCommaStr(param.preFrscAmt5));
        $("#preFrscAmt6_"+rowId).html(addCommaStr(param.preFrscAmt6));
        ...
        $("#dmnFrscAmt3_"+rowId).html(addCommaStr(param.dmnFrscAmt3));
        $("#dmnFrscAmt4_"+rowId).html(addCommaStr(param.dmnFrscAmt4));
        $("#dmnFrscAmt5_"+rowId).html(addCommaStr(param.dmnFrscAmt5));
        $("#dmnFrscAmt6_"+rowId).html(addCommaStr(param.dmnFrscAmt6));
        $("#dmnCharAmt1_"+rowId).html(addCommaStr(param.dmnCharAmt1));
        $("#dmnCharAmt2_"+rowId).html(addCommaStr(param.dmnCharAmt2));
        $("#dmnCharAmt3_"+rowId).html(addCommaStr(param.dmnCharAmt3));
       
        $("#preDefFrscAmt0_"+rowId).html(addCommaStr(param.preDefFrscAmt0));
        $("#preDefFrscAmt1_"+rowId).html(addCommaStr(param.preDefFrscAmt1));
        $("#preDefFrscAmt2_"+rowId).html(addCommaStr(param.preDefFrscAmt2));
        $("#preDefFrscAmt3_"+rowId).html(addCommaStr(param.preDefFrscAmt3));
        $("#preDefFrscAmt4_"+rowId).html(addCommaStr(param.preDefFrscAmt4));
        $("#preDefFrscAmt5_"+rowId).html(addCommaStr(param.preDefFrscAmt5));
        $("#preDefFrscAmt6_"+rowId).html(addCommaStr(param.preDefFrscAmt6));
        $("#preDefCharAmt1_"+rowId).html(addCommaStr(param.preDefCharAmt1));
        $("#preDefCharAmt2_"+rowId).html(addCommaStr(param.preDefCharAmt2));
        $("#preDefCharAmt3_"+rowId).html(addCommaStr(param.preDefCharAmt3));
       
        $("#frscAmt0_"+rowId).html(addCommaStr(param.frscAmt0));
        $("#frscAmt1_"+rowId).html(addCommaStr(param.frscAmt1));
        $("#frscAmt2_"+rowId).html(addCommaStr(param.frscAmt2));
        $("#frscAmt3_"+rowId).html(addCommaStr(param.frscAmt3));
        $("#frscAmt4_"+rowId).html(addCommaStr(param.frscAmt4));
        $("#frscAmt5_"+rowId).html(addCommaStr(param.frscAmt5));
        $("#frscAmt6_"+rowId).html(addCommaStr(param.frscAmt6));
        $("#charAmt1_"+rowId).html(addCommaStr(param.charAmt1));
        $("#charAmt2_"+rowId).html(addCommaStr(param.charAmt2));
        $("#charAmt3_"+rowId).html(addCommaStr(param.charAmt3));
    ...
    reportWirte020OpenDialogDgrcompoModify = function(rowId){  
        var rowData = reportWrite020PageGrid.getRowData(rowId);
    ...
    var upDgrcompoNmFormatter = function(cellValue, options, rowObject){
        ...
        var reportDetlNm = isEmpty(rowObject.reportDetlNm) == true ? "" : rowObject.reportDetlNm;
    ...
    var examContFormatter = function(cellValue, options, rowObject){
        ...
        if(rowObject.compoLevel != 1){
            styleStr = 'style="display:none;width:205px;"';
        }else{
            styleStr = 'style="width:205px;"';
        }
        ...
        var rVal = '<div>'
                 ...
                 + '</select>'
                 + '&nbsp;<input id="investPlan_'+rowObject.dgrcompoId+'" value="'+investPlan+'" maxlength="20" class="ui-state-enabled" '+styleStr +' />'+'<br>'
                 + '<textarea id="examCont_'+rowObject.dgrcompoId+'" style="width:300px;ime-mode:active;" cols="22" rows="12">'+cellValue+'</textarea>'
                 + '</div>';
    ...
    var srchValFormatter = function(cellValue, options, rowObject){
        ...
        var rVal = '<div>'
                 ...
                 + '<br><textarea id="srchVal_'+rowObject.dgrcompoId+'" '+styleStr+'" cols="22" rows="12">'+cellValue+'</textarea>'
                 + '</div>';
    ...
    var preFrscAmtFormatter = function(cellValue, options, rowObject){
        ...
        var rVal = '<table class="jqgridSubTable">'
                 ...
                 + '      <td id="preFrscAmt0_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(cellValue)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preFrscAmt1_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preFrscAmt1)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preFrscAmt2_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preFrscAmt2)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preFrscAmt3_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preFrscAmt3)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preFrscAmt4_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preFrscAmt4)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preFrscAmt5_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preFrscAmt5)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preFrscAmt6_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preFrscAmt6)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preCharAmt1_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preCharAmt1)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preCharAmt2_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preCharAmt2)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="preCharAmt3_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.preCharAmt3)+'</td>'
                 + '    </tr>'
                 + '  </tbody>'
                 + '</table>';
    ...
    var dmnFrscAmtFormatter = function(cellValue, options, rowObject){
        ...
        var rVal = '<table class="jqgridSubTable">'
                 ...
                 + '  <tbody>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnFrscAmt0_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(cellValue)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnFrscAmt1_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnFrscAmt1)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnFrscAmt2_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnFrscAmt2)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnFrscAmt3_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnFrscAmt3)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnFrscAmt4_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnFrscAmt4)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnFrscAmt5_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnFrscAmt5)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnFrscAmt6_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnFrscAmt6)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnCharAmt1_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnCharAmt1)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnCharAmt2_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnCharAmt2)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="dmnCharAmt3_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.dmnCharAmt3)+'</td>'
                 + '    </tr>'
                 + '  </tbody>'
                 + '</table>';
    ...
    var frscAmtFormatter = function(cellValue, options, rowObject){
        ...
        var rVal = '<table class="jqgridSubTable">'
                 ...
                 + '  <tbody>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="frscAmt0_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(cellValue)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="frscAmt1_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.frscAmt1)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="frscAmt2_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.frscAmt2)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="frscAmt3_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.frscAmt3)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="frscAmt4_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.frscAmt4)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="frscAmt5_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.frscAmt5)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="frscAmt6_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.frscAmt6)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="charAmt1_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.charAmt1)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="charAmt2_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.charAmt2)+'</td>'
                 + '    </tr>'
                 + '    <tr class="amtView020Tr">'
                 + '      <td id="charAmt3_'+rowObject.dgrcompoId+'" class="amtView020Td">'+addCommaStr(rowObject.charAmt3)+'</td>'
                 + '    </tr>'
                 + '  </tbody>'
                 + '</table>';
  ...
  //투자사업유형 그리드fomatter
    ...
    var colNames = ['', '[실국-부서-조서-세부]', '구분', '정렬순서', '총사업비', '기투자<br/>(전전년까지)', '기정액<br/>(당해년도)', '전년도 투자<br/>(최종예산)', '요구액', '조정액', '향후투자계획', '검토내용', '공약정보', '조건검색어',
                    ...
                    'investPlan','indiAttr','advncProc', 'teMngMokNm'
                   ];
    ...
    var colModel = [ {name : 'edit', index : 'edit', width : 20, sortable : false, fixed : true, align : 'center', cellattr: myCellattr,
                        ...
                        {name : 'reportSortSeqView', index : 'reportSortSeqView', width : 60, sortable : false, fixed : true, align : 'center', cellattr: myCellattr,
                        ...
                        {name : 'examContView', index : 'examContView', width : 325, sortable : false, fixed : true, align : 'left', cellattr: myCellattr,
...
/*    var colNames = ['', '[실국-부서-조서-세부]', '구분', '정렬순서', '총사업비', '기투자', '본예산', '전년도 투자', '요구액', '조정액', '향후투자계획', '검토내용', '공약정보', '조건검색어',
                    'dgrcompoId', 'upDgrcompoId', 'fisYear', 'bgtDgr', 'reportCd', 'reportDetlCd', 'dgrLevel', 'teBgtCompoId', 'teBgtCompoSeq', 'compoLevel', 'demandCont', 'examCont', 'reflectFg', 'srchVal', 'reportSortSeq', 'mayorReportYn', 
                    'totFrscAmt1', 'totFrscAmt2', 'totFrscAmt3', 'totFrscAmt4', 'totFrscAmt5', 'totFrscAmt6', 'totCharAmt1', 'totCharAmt2', 'totCharAmt3',
                    'preInvFrscAmt1', 'preInvFrscAmt2', 'preInvFrscAmt3', 'preInvFrscAmt4', 'preInvFrscAmt5', 'preInvFrscAmt6', 'preInvCharAmt1', 'preInvCharAmt2', 'preInvCharAmt3',
                    'checkYn3250000', 'checkYn3260000', 'checkYn3270000', 'checkYn3280000', 'checkYn3290000', 'checkYn3300000', 'checkYn3310000', 'checkYn3320000',
...
*/    
    var getGridHeight = function (){
    	...
    	$("#REPORT_WRITE020PAGE_GRD", tabObj).closest(".ui-jqgrid-bdiv").css("max-height", height - 10);
        return height;
    };
    
    var mainBodyResize = function(){
        if(isEmpty($("#REPORT_WRITE020PAGE_GRD", $("#"+tabId))) == false){
            $("#REPORT_WRITE020PAGE_GRD", $("#"+tabId)).setGridHeight(getGridHeight());
            $("#REPORT_WRITE020PAGE_GRD", $("#"+tabId)).setGridWidth($("#mainCenter", tabObj).width()-20);
        }
    };
    ...
    var reportWrite020PageGrid = $("#REPORT_WRITE020PAGE_GRD", tabObj);
    ...
    var doSearchCallBack = function(data){
        ...
        if(data.data.bgtDgr == "1"){
            ...
            groupHeaders = [{startColumnName : 'dmnFrscAmt0',numberOfColumns : 2, titleText : '당해연도 투자계획'}, {startColumnName : 'reportMstr', numberOfColumns : 3, titleText : '분류'}];
        }else{
            colModel[6].hidden = false;
            colModel[7].hidden = true;
            groupHeaders = [{startColumnName : 'dmnFrscAmt0',numberOfColumns : 2, titleText : '금회추경 투자계획'}, {startColumnName : 'reportMstr', numberOfColumns : 3, titleText : '분류'}];
        }
        
        $("#REPORT_WRITE020PAGE_GRD", tabObj).jqGrid('GridUnload');
        reportWrite020PageGrid = $("#REPORT_WRITE020PAGE_GRD", tabObj);
        reportWrite020PageGrid.csTreeGrid({
            datastr : data,
        ...
        $("#REPORT_WRITE020PAGE_GRD", tabObj).closest(".ui-jqgrid-bdiv").css("max-height", getGridHeight() - 10);
        
        reportWrite020PageGrid.jqGrid('setGroupHeaders', {
    ...
    reportWrite020PageDoPageSearch = function(page) {
        var saveDatas = getSaveDatas(reportWrite020PageGrid, $("#REPORT_WRITE020PAGE_GRD", tabObj)[0].rows);
    ...
    var doCondInit = function(){
      ...
      //분류항목(RP015)·투자사업유형(RP014) selectBox 세팅
    ...
    $(tabObj).off("change.report020PageSave input.report020PageSave").on("change.report020PageSave input.report020PageSave", "#REPORT_WRITE020PAGE_GRD :input", function(){
  ...
  //보고항목 체크된 코드 가져오기
            ...
            callBack : function() {
                ...
                if(isEmpty(saveDatas) == false){
                    for(var i = 0; i < saveDatas.length; i++){
                        if(saveDatas[i].srchValYn === "Y"
                                || saveDatas[i].reflegFgYn === "Y"
                                || saveDatas[i].reportSortSeqYn === "Y"
                                || saveDatas[i].mayorReportChangeYn === "Y"){
                            needReload = true;
                            break;
                        }
                        for(var k in saveDatas[i]){
                            if(k && k.indexOf("checkYn") === 0 && k.lastIndexOf("Yn") === k.length - 2
                                    && saveDatas[i][k] === "Y"){
                                needReload = true;
                                break;
                            }
                ...
                if(needReload){
                    ...
                    for(var j = 0; j < saveDatas.length; j++){
                        ...
                        try{
                            reportWrite020PageGrid.setRowData(rid, {
                                demandCont : sd.demandCont,
                                examCont : sd.examCont,
                                reflectFg : sd.reflectFg,
                                srchVal : sd.srchVal,
                                reportSortSeq : sd.reportSortSeq,
                                mayorReportYn : sd.mayorReportYn,
                                investPlan : sd.investPlan,
                                indiAttr : sd.indiAttr,
                                advncProc : sd.advncProc,
                                totFrscAmt1 : sd.totFrscAmt1,
                                totFrscAmt2 : sd.totFrscAmt2,
                                totFrscAmt3 : sd.totFrscAmt3,
                                totFrscAmt4 : sd.totFrscAmt4,
                                totFrscAmt5 : sd.totFrscAmt5,
                                totFrscAmt6 : sd.totFrscAmt6,
                                totCharAmt1 : sd.totCharAmt1,
                                totCharAmt2 : sd.totCharAmt2,
                                totCharAmt3 : sd.totCharAmt3,
                                preInvFrscAmt1 : sd.preInvFrscAmt1,
                                preInvFrscAmt2 : sd.preInvFrscAmt2,
                                preInvFrscAmt3 : sd.preInvFrscAmt3,
                                preInvFrscAmt4 : sd.preInvFrscAmt4,
                                preInvFrscAmt5 : sd.preInvFrscAmt5,
                                preInvFrscAmt6 : sd.preInvFrscAmt6,
                                preInvCharAmt1 : sd.preInvCharAmt1,
                                preInvCharAmt2 : sd.preInvCharAmt2,
                                preInvCharAmt3 : sd.preInvCharAmt3,
                                checkYn3250000 : sd.checkYn3250000,
                                checkYn3260000 : sd.checkYn3260000,
                                checkYn3270000 : sd.checkYn3270000,
                                checkYn3280000 : sd.checkYn3280000,
                                checkYn3290000 : sd.checkYn3290000,
                                checkYn3300000 : sd.checkYn3300000,
                                checkYn3310000 : sd.checkYn3310000,
                                checkYn3320000 : sd.checkYn3320000,
                                checkYn3330000 : sd.checkYn3330000,
                                checkYn3340000 : sd.checkYn3340000,
                                checkYn3350000 : sd.checkYn3350000,
                                checkYn3360000 : sd.checkYn3360000,
                                checkYn3370000 : sd.checkYn3370000,
                                checkYn3380000 : sd.checkYn3380000,
                                checkYn3390000 : sd.checkYn3390000,
                                checkYn3400000 : sd.checkYn3400000
                            });
                        }catch(e){}
                    }
                }
    ...
    $("#rankBtn", tabObj).click(function() {
        ...
        $("#dialogDgroffice020SortCallBackFunction", $("#dialogDgroffice020SortDiv")).val("reportWrite020PageDialogDgroffice020SortCallBackFunction");
    ...
    reportWrite020PageDialogDgroffice020SortCallBackFunction = function(param){
        $.csAlert({
    ...
    var openDialogBgtDeptSelt = function(seltFg){
        ...
        $("#dialogDgrDeptSeltCallBackFunction", $("#dialogDgrDeptSeltDiv")).val("reportWrite020PageDialogDgrDeptSeltCallBack");
    ...
    reportWrite020PageDialogDgrDeptSeltCallBack = function(param){
