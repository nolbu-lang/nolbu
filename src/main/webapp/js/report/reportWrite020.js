$(document).ready(function() {
    ...
    var getSearchParam = function(){
        ...
        // 심사조서 보고항목선택에서 지정한 분류항목(ADVNC_PROC)·투자사업유형(INDI_ATTR)
    ...
    $(tabObj).off("change.report020Save input.report020Save").on("change.report020Save input.report020Save", "#REPORT_WRITE020_GRD :input", function(){
            ...
            callBack : function() {
                    ...
                    for(var i = 0; i < saveDatas.length; i++){
                        ...
                        for(var k in saveDatas[i]){
                            if(k && k.indexOf("checkYn") === 0 && k.lastIndexOf("Yn") === k.length - 2
                                    && k !== "checkYnChangeYn" && saveDatas[i][k] === "Y"){
                                needReload = true;
                                break;
                            }
                        }
                ...
                if(needReload){
                    ...
                    for(var j = 0; j < saveDatas.length; j++){
                        ...
                        try{
                            reportWrite020Grid.setRowData(rid, {
