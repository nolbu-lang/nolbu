...
%>
<script>
_manageCloseTabId = "<%=tabId%>";
</script>
<script src="${pageContext.request.contextPath}/js/manage/manageClose.js"></script>
  ...
  <div id="mainBody" class="nondiv" style="height: 95%; margin: 0 auto; width: 100%; min-width: 700px; _width: 700px; overflow: auto;">
    ...
    <div id="mainCenter" class="pane ui-layout-center" style="border: 3px;">
      <div class="gridHeader" style="float:none;">
        <span id="MANAGE_CLOSE_LIST_TOT">총건수 : 0건</span>
      </div>
      <div id="MANAGE_CLOSE_LIST_DIV" class="csGrid" style="border: 0px;">
        <table id="MANAGE_CLOSE_LIST_GRD" style="border: 0px; height: 100%;"></table>
      </div>
      <div id="MANAGE_CLOSE_LIST_PGR" class="paging" style="width: 788px;"></div>
    </div>
  </div>
</div>