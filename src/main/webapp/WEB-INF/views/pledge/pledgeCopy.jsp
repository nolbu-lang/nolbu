...
%>
<script>
  _pledgeCopyTabId = "<%=tabId%>";
</script>
<script src="${pageContext.request.contextPath}/js/pledge/pledgeCopy.js"></script>
        ...
        <table>
          ...
          <tbody>
            <tr>
              <th>공약정보</th>
              <td colspan="5">
                <select id="condPledgeInfoId" name="condPledgeInfoId" title="공약정보" style="width:70px;">
                </select>
    ...
    <div id="mainCenter" class="pane ui-layout-center" style="border:0px;overflow:hidden;">
      <div id="subMainBody" class="nondiv" style="height:100%;margin: 0 auto;width: 100%;overflow: auto;">
        <div id="subMainCenter" class="pane ui-layout-center" style="border:0px;overflow:hidden;">
          ...
          <div id="PLEDGE_COPY_DIV" class="csGrid" style="border:0px;height:100%;">
            <table id="PLEDGE_COPY_GRD" style="border:0px;height:100%;"></table>
          </div>
        </div>
        <div id="subMainWest" class="pane ui-layout-west" style="border:0px;overflow:hidden;">
          ...
          <div id="PLEDGE_COPY_SRC_DIV" class="csGrid">
            <table id="PLEDGE_COPY_SRC_GRD" ></table>
          </div>
        </div>
      </div>
    </div>
