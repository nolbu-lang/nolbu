...
%>
<script>
_reportWrite040TabId = "<%=tabId%>";
</script>
<script src="${pageContext.request.contextPath}/js/report/reportWrite040.js"></script>
...
<div class="contents" style="height:100%;">
  ...
  <div id="mainBody" class="nondiv" style="height:95%;margin: 0 auto;width: 100%;min-width: 700px;_width: 700px;overflow: auto;">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <th>조서상세구분</th>
              <td colspan="2">
                <input type="hidden" id="condReportCd" name="condReportCd" value="040"/>
    ...
    <div id="mainCenter" class="pane ui-layout-center" style="border:0px;">
      ...
      <div id="REPORT_WRITE040_DIV" class="csGrid" style="border:0px;">
        <table id="REPORT_WRITE040_GRD" style="border:0px;height:100%;"></table>
      </div>
    </div>
  </div>
  <!--list e-->
