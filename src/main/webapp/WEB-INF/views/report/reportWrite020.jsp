...
%>
<script>
_reportWrite020TabId = "<%=tabId%>";
</script>
<script src="${pageContext.request.contextPath}/js/report/reportWrite020.js?v=20260830a"></script>
...
<div class="contents" style="height:100%;">
  ...
  <div id="mainBody" class="nondiv" style="height:95%;margin: 0 auto;width: 100%;min-width: 700px;_width: 700px;overflow: auto;">
    ...
    <div id="mainCenter" class="pane ui-layout-center" style="border:0px;">
      ...
      <div id="REPORT_WRITE020_DIV" class="csGrid" style="border:0px;">
        <table id="REPORT_WRITE020_GRD" style="border:0px;height:100%;"></table>
      </div>
    </div>
  </div>
  <!--list e-->
