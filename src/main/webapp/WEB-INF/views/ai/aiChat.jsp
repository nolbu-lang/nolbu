...
--%>
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/css/ai/aiChat.css?v=20260706b" />
...
<script src="${pageContext.request.contextPath}/js/ai/aiChat.js?v=20260706b"></script>
