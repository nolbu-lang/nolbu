...
%>
<script>
_budgetSheetSelectTabId = "<%=tabId%>";
</script>
<script src="${pageContext.request.contextPath}/js/budget/budgetSheetSelect.js"></script>
...
<div class="contents" style="height:100%;">
  ...
  <div id="mainBody" class="nondiv" style="height:95%;margin: 0 auto;width: 100%;min-width: 700px;_width: 700px;overflow: auto;">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <th>집계표항목구분</th>
              <td colspan="2">
                <select id="condSheetCd" name="condSheetCd" title="집계표항목구분" style="width:93%;">
                </select>
              </td>
              <td colspan="2">
                <select id="condSheetDetlCd" name="condSheetDetlCd" title="집계표항목상세구분" style="width:93%;">
                </select>
              </td>
              <td>&nbsp;</td>
            </tr>
    ...
    <div id="mainCenter" class="pane ui-layout-center" style="border:0px;">
      ...
      <div id="BUDGET_SHEET_SELECT_DIV" class="csGrid" style="border:0px;">
        <table id="BUDGET_SHEET_SELECT_GRD" style="border:0px;height:100%;"></table>
      </div>
    </div>
  </div>
  <!--list e-->
