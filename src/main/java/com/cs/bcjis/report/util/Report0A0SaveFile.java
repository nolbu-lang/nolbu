...
@Component("report0A0SaveFile")
public class Report0A0SaveFile {
    ...
    public int writeData(XSSFSheet sheet, int rowNum, JSONObject category, Map<String, CellStyle> styles, int dataCnt, boolean bgtCompoFlag, ReportFormulaUtil reportFormulaUtil) throws Exception {
        ...
        List<Report0A0SaveFrscAmtsVO> frscAmts = getFrscAmts(category, bgtCompoFlag);
        ...
        long frscAmt = 0l;
        Report0A0SaveFrscAmtsVO report0A0SaveFrscAmtsVO = null;
        if (!frscAmts.isEmpty()) {
            report0A0SaveFrscAmtsVO = frscAmts.remove(0);
            frscNm = report0A0SaveFrscAmtsVO.getFrscNm();
            dmnFrscAmt = report0A0SaveFrscAmtsVO.getDmnFrscAmt();
            preFrscAmt = report0A0SaveFrscAmtsVO.getPreFrscAmt();
            preDefFrscAmt = report0A0SaveFrscAmtsVO.getPreDefFrscAmt();
            frscAmt = report0A0SaveFrscAmtsVO.getFrscAmt();
        }
    ...
    public List<Report0A0SaveFrscAmtsVO> getFrscAmts(JSONObject category, boolean bgtCompoFlag) {
        List<Report0A0SaveFrscAmtsVO> list = new ArrayList<Report0A0SaveFrscAmtsVO>();
        ...
        if (bgtCompoFlag == false) {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || preDefFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("시", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
            }
        } else {
        ...
        if (bgtCompoFlag == false) {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || preDefFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("국", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
            }
        } else {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("국", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
        ...
        if (bgtCompoFlag == false) {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || preDefFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("교", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
            }
        } else {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("교", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
        ...
        if (bgtCompoFlag == false) {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || preDefFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("지", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
            }
        } else {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("지", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
        ...
        if (bgtCompoFlag == false) {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || preDefFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("채", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
            }
        } else {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("채", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
        ...
        if (bgtCompoFlag == false) {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || preDefFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("기", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
            }
        } else {
            if (dmnFrscAmt != 0 || preFrscAmt != 0 || frscAmt != 0) {
                list.add(new Report0A0SaveFrscAmtsVO("기", dmnFrscAmt, preFrscAmt, preDefFrscAmt, frscAmt));
