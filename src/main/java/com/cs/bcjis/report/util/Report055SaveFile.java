...
@Component("report055SaveFile")
public class Report055SaveFile {
    ...
    public void data(Map model, XSSFWorkbook wb, List<Object> categories) throws Exception {
        ...
        while (!categories.isEmpty()) {
            ...
            if (dgrLevel == 0) {
                if (sheet != null) {
                    ReportSaveUtil.writeLastSheet(reportCommDAO, model, wb, sheet, rowNum, styles, reportInfo, 11);
                ...
                rowNum = writeHeader(model, sheet, rowNum, styles, reportInfo, ReportSaveUtil.getStringValue(reportInfo.get("reportNm")), 11);
    ...
    public int writeData(XSSFSheet sheet, int rowNum, JSONObject category, Map<String, CellStyle> styles, boolean bgtCompoFlag, ReportFormulaUtil reportFormulaUtil) throws Exception {
        ...
        if (formulaFlag == false) {
            cell.setCellValue(ReportSaveUtil.getAmtValue(category.get("judgRsltAmt")));
        }
        ...
        cell.setCellFormula("H" + (rowNum) + "-" + "J" + (rowNum));
        ...
        cell.setCellFormula("N" + rowNum + "+" + "O" + rowNum + "+" + "P" + rowNum + "+" + "Q" + rowNum + "+" + "R" + rowNum + "+" + "S" + rowNum);
        ...
        cell.setCellStyle(styles.get(preStyleNm + "Col19"));
    ...
    public void dataList(Map model, XSSFWorkbook wb, List<Object> categories) throws Exception {
        ...
        if("056".equals(reportDetlCd)){
        	title = "국외업무여비";
        }else if("057".equals(reportDetlCd)){
        	title = "국제화여비";
        }else{
        	title = "국외업무여비";
        }
        ...
        for (int i = 0; i < categories.size(); i++) {
            ...
            if(dgrLevel == 0 || dgrLevel == 4 || dgrLevel == 6){ //부서랑 항목만
