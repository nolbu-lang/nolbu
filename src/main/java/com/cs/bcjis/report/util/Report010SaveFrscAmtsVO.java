...
public class Report010SaveFrscAmtsVO {
    private String frscNm = "";
    private long dmnFrscAmt = 0l;
    private long preFrscAmt = 0l;
    private long preDefFrscAmt = 0l;
    private long frscAmt = 0l;

    public Report010SaveFrscAmtsVO(String frscNm, long dmnFrscAmt, long preFrscAmt, long preDefFrscAmt, long frscAmt) {
        this.frscNm = frscNm;
    ...
    public String toString() {
        return "Report010SaveFrscAmtsVO [frscNm=" + frscNm + ", dmnFrscAmt=" + dmnFrscAmt + ", preFrscAmt=" + preFrscAmt + ", preDefFrscAmt=" + preDefFrscAmt + ", frscAmt=" + frscAmt + "]";
    }
